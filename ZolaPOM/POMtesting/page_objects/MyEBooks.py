...
class MyEBooks:
    ...
    def click_all_books_see_all(self):
        ...
        self._webd_wrap._driver.find_element_by_xpath("/html/body/div[2]/div/section[2]/section/div/div[2]/a").click()
  
    def click_purchased_see_all(self):  
        self.confirm_page()
        
        self._webd_wrap.find_element_by_xpath('/html/body/div[2]/div/section[2]/section[2]/div/div[2]/a').click()
