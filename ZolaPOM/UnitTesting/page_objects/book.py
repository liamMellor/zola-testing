...
class book(base_page_object):
    ...
    def click_recommend(self):
        ...
        _recc = self._webd_wrap._driver.find_element_by_xpath('/html/body/div[2]/div/section[2]/div[2]/div/div/ul/li[3]/a')
        
        self._webd_wrap._driver.execute_script('$(arguments[0]).click()', _recc)
