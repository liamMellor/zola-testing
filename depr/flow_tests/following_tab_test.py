...
class FollowerTabSide(unittest.TestCase):
    ...
    def test_follower_tab_side(self):
        ...
        #driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/a[2]/div/span[2]").click()
        driver.find_element_by_class_name("mod-info").find_element_by_xpath("span[2]").click()
        #/html/body/div[3]/div/div[2]/a[2]/div/span[2]
        #driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/header/h2")
