...
class FollowerTabSide(unittest.TestCase):
    ...
    def test_follower_tab_side(self):
        ...
        #driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/a[4]/div/div/img").click()
        driver.find_element_by_class_name("l-full").find_element_by_xpath("header/h5")
        driver.find_element_by_class_name("activity-mod-and-info").find_element_by_xpath("div/div/div/ul/li/div/a/img").click()
        driver.find_element_by_class_name('l-570px').find_element_by_xpath('div/section/div[3]/div/div[2]/a')
