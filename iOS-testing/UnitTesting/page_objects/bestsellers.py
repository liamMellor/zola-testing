...
#            raise AssertionError("Not on the bestsellers page.")     
    ...
    ########################################################################
    ########################################################################
    def click_bestseller_book(self, book_num):
        self.confirm_page()
        self._webd_wrap._driver.find_element_by_class_name('l-main-primary').find_element_by_xpath('section['+str(book_num+2)+']/div/a').click()
        print (datetime.now().strftime('%Y-%m-%d %H:%M:%S')), "Purchasing Book Number:", str(book_num+1)
    ...
    def click_eighth_book(self):
        ...
        self._webd_wrap._driver.find_element_by_class_name('l-main-primary').find_element_by_xpath('section[7]/div/div/a[1]').click()
    ...
    def click_buy_eighth_book(self):
        ...
        self._webd_wrap._driver.find_element_by_class_name('l-main-primary').find_element_by_xpath('section[7]/div/div/div[1]/a').click()
    ...
    def get_eighth_book_title(self):
        ...
        self._webd_wrap.wait.until(EC.visibility_of_element_located((By.CLASS_NAME, 'l-main-primary')))
        _book_title = self._webd_wrap._driver.find_element_by_class_name('l-main-primary').find_element_by_xpath('section[7]/div/div/a')
        return _book_title.text
