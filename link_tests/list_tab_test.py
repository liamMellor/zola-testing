...
class FollowerTabSide(unittest.TestCase):
    ...
    def test_follower_tab_side(self):
        ...
        driver.find_element_by_class_name("border-dotted-bottom").find_element_by_xpath("a/div").click()
        driver.find_element_by_class_name("l-full").find_element_by_xpath("header/a")
